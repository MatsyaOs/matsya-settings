...
Canvas {
    ...
    property color textColor: MatsyaUI.Theme.textColor
    property color bgColor: MatsyaUI.Theme.secondBackgroundColor
    property color highlightColor: MatsyaUI.Theme.highlightColor
...
//        c.rect(xPadding - 1, yPadding - 1, plotWidth + 2, plotHeight + 2);
        ...
        c.textAlign = "center"
        c.lineWidth = 1
        c.strokeStyle = MatsyaUI.Theme.darkMode ? 'rgba(0, 0, 0, 0.35)' : 'rgba(0, 0, 0, 0.15)'
