...
PowerManager::PowerManager(QObject *parent)
    : QObject(parent)
    , m_iface("com.matsya.PowerManager",
              "/CPUManagement", "com.matsya.CPUManagement",
    ...
    , m_mode(-1)
{
    ...
    QSettings settings(QSettings::UserScope, "matsyaos", "power");
...
void PowerManager::setIdleTime(int idleTime)
{
    if (m_idleTime != idleTime) {
        ...
        QDBusInterface iface("com.matsya.PowerManager",
                             "/PowerManager", "com.matsya.PowerManager",
                             QDBusConnection::sessionBus());
        if (iface.isValid()) {
